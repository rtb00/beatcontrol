      ...
      <article className="max-w-2xl mx-auto px-4 py-20 md:py-24">
        ...
        <div className="prose prose-lg text-fg leading-relaxed space-y-6">
          ...
          <p>
            ...
            <Link href="/auth/signin?callbackUrl=/dj" className="text-neon-gold underline">
              hier anmelden
            </Link>{' '}
            oder mir direkt eine{' '}
            <a href="mailto:nibor.bauer1+beatcontrol@gmail.com" className="text-neon-gold underline">
              Mail schicken
            </a>
            .
          </p>
          ...
          <p className="text-sm text-fg-muted mt-8">
            ...
            <Link href="/impressum" className="text-neon-gold underline">Impressum</Link>.
          </p>
        </div>
      </article>
