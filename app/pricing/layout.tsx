...
const PRICING_JSON_LD = {
  ...
  offers: [
    ...
    },
    {
      ...
      priceCurrency: 'EUR',
      description:
        'Jahres-Abo für aktive DJs (239,88 € pro Jahr, monatlich 49,99 €): unbegrenzte Events und Songwünsche, eigenes Branding mit Namen und Logo. 30 Tage Geld-zurück-Garantie.',
    },
    {
      '@type': 'Offer',
      name: 'Team',
