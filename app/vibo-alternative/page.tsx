...
export default function ViboAlternative() {
  ...
  const rows = [
    ...
    { feature: 'Pricing pro DJ/Monat',    vibo: '$179 (~€165)', beatcontrol: '€4,08 (Pro, jährlich)', winner: 'beatcontrol' },
    ...
    <div className="min-h-screen bg-rave-gradient text-fg font-sans">
      ...
      <article className="max-w-3xl mx-auto px-4 py-20 md:py-24">
        ...
        <ul className="list-disc pl-6 space-y-3 text-fg-muted leading-relaxed mb-6">
          ...
          <li>
            <strong className="text-fg">Du willst nicht €165/Mo zahlen.</strong> BeatControl Pro kostet 49 € im Jahr. Für DJs mit 20 bis 30 Hochzeiten im Jahr sind das rund 1.900 € Unterschied.
          </li>
          <li>
