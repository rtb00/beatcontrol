    ...
    <Modal isOpen={isOpen} onClose={onClose} tone="party">
      <div className="flex items-start justify-between gap-4 mb-2">
        ...
        <button
          ...
          className="p-2 -m-2 -mt-1 text-fg-muted hover:text-fg transition-colors"
        >
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Link href="/auth/register?plan=pro_yearly" className={buttonVariants({ variant: 'primary', size: 'md', className: 'flex-1' })}>
          Pro starten
        </Link>
      </div>
