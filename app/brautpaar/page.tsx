    ...
    <div className="min-h-screen bg-rave-gradient text-fg font-sans">
      ...
      <section className="relative overflow-hidden">
        ...
        <p className="text-fg/90 [text-shadow:0_1px_4px_rgba(0,0,0,0.6)] text-lg leading-relaxed max-w-2xl mx-auto mb-10">
          Mit BeatControl scannen eure Gäste einen QR-Code, wünschen sich ihre Songs und stimmen über die Wünsche der anderen ab. Mit diesem sechsten Sinn weiß euer DJ den ganzen Abend, welche Songs eure Leute abfeiern.
        </p>
        ...
        <Link
          href="#wie"
          className="inline-block mt-6 text-sm text-fg-muted/80 hover:text-turquoise transition-colors underline underline-offset-4 decoration-fg-muted/30"
        >
          Wie es funktioniert
        </Link>
        </div>
      ...
      <section className="bg-panel py-16 border-y border-line">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <blockquote className="font-display text-2xl md:text-3xl leading-relaxed text-fg mb-6">
            72 Songwünsche auf der letzten Hochzeit mit BeatControl.
          </blockquote>
