  ...
  return (
    <CalmScope className="min-h-screen bg-base text-fg font-sans">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16">
        ...
        <h1 className="font-display text-3xl md:text-4xl font-bold mb-3">Datenschutzerklärung</h1>
        <p className="text-sm text-fg-muted mb-12">Stand: April 2026</p>

        <div className="space-y-12 text-fg leading-relaxed">

          <section>
            <h2 className="font-display text-2xl font-bold mb-4">1. Verantwortlicher</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">2. Allgemeines zur Datenverarbeitung</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">3. Hosting (Vercel)</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">4. Datenbank (Neon)</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">5. Server-Logfiles</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">6. Registrierung und Nutzerkonto</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">7. Anmeldung mit Google (OAuth 2.0)</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">8. Cookies</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">9. Musikwünsche der Gäste</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">10. Zahlungsabwicklung (Stripe)</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">11. Weitergabe von Daten</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">12. Speicherdauer</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">13. Deine Rechte</h2>
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">14. Datensicherheit</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">15. Änderungen dieser Datenschutzerklärung</h2>
            <p>
